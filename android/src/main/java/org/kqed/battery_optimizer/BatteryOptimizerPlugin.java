package org.kqed.battery_optimizer;
...
/**
 * BatteryOptimizerPlugin
 */
public class BatteryOptimizerPlugin implements FlutterPlugin, MethodCallHandler, ActivityAware {
    ...
    public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
        channel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "battery_optimizer");
